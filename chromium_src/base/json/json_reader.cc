...
// Note: list_append_i64, list_append_u64, dict_set_i64, dict_set_u64 are
// provided as NOTIMPLEMENTED() stubs below (matching Brave upstream). They can
// be hooks into base::Value for 64-bit ints; for now they are not implemented.
...
// `serde_json_lenient` to `base::Value`, and let us store binary blobs
