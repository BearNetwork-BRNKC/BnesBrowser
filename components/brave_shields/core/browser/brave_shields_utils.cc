...
#include "BnesBrowser/components/brave_shields/core/common/brave_shields_panel.mojom-data-view.h"
...
#include "BnesBrowser/components/content_settings/core/common/content_settings_util.h"
