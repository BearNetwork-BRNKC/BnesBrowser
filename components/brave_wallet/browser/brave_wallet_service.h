...
#include "BnesBrowser/components/brave_wallet/browser/asset_discovery_manager.h"
...
#include "BnesBrowser/components/brave_wallet/browser/tx_service_observer_base.h"
