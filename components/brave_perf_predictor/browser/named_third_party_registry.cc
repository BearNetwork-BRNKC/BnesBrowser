...
#include "BnesBrowser/components/brave_perf_predictor/browser/named_third_party_registry.h"
...
#include "BnesBrowser/components/brave_perf_predictor/browser/bandwidth_linreg_parameters.h"
