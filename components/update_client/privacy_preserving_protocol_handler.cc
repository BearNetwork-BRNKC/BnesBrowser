...
#include "BnesBrowser/components/update_client/privacy_preserving_protocol_handler.h"

#include <memory>

#include "BnesBrowser/components/update_client/privacy_preserving_protocol_serializer.h"
