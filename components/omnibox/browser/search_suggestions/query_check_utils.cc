...
#include "BnesBrowser/components/omnibox/browser/search_suggestions/query_check_utils.h"
...
#include "BnesBrowser/components/omnibox/browser/search_suggestions/query_check_constants.h"
