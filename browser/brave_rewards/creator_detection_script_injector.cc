...
#include "BnesBrowser/browser/brave_rewards/creator_detection_script_injector.h"
...
#include "BnesBrowser/components/brave_rewards/resources/grit/creator_detection_generated.h"
