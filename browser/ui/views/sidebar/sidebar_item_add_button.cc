...
#include "BnesBrowser/browser/ui/views/sidebar/sidebar_item_add_button.h"
...
#include "BnesBrowser/browser/ui/views/sidebar/sidebar_add_item_bubble_delegate_view.h"
