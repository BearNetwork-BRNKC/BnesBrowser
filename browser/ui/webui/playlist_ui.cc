...
#include "BnesBrowser/browser/ui/playlist/playlist_dialogs.h"
...
#include "BnesBrowser/components/playlist/content/browser/resources/grit/playlist_generated_map.h"
